...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    uz: {
      ...
      details_body: "Sana: 30.08.2026 | Vaqt: 18:00 (Zaks: 13:00)<br>Manzil: Toshkent viloyat Toshkent tumani, Shamsiobod shaharchasi<br>Mo’ljal: Oltintepa markazi",
      location_button: "Xaritada ko'rish",
    ...
    kz: {
      ...
      details_body: "Күні: 30.08.2026 | Уақыты: 18:00 (ЗАГС: 13:00)<br>Мекен-жайы: Ташкент облысы, Ташкент ауданы, Шамсиобод қалашығы<br>Бағдар: Олтинтепа орталығы",
      location_button: "Картада қарау",
    ...
    ru: {
      ...
      details_body: "Дата: 30.08.2026 | Время: 18:00 (Закс: 13:00)<br>Место: Ташкентская область, Ташкентский район, городок Шамсиобод<br>Ориентир: центр Олтинтепа",
      location_button: "Посмотреть на карте",
    ...
    en: {
      ...
      details_body: "Date: 30.08.2026 | Time: 18:00 (Registration: 13:00)<br>Venue: Tashkent region, Tashkent district, Shamsiobod town<br>Landmark: Oltintepa center",
      location_button: "View on Map",
